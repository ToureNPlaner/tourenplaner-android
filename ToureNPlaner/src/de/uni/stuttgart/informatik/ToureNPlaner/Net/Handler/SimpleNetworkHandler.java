...
public abstract class SimpleNetworkHandler extends AsyncHandler{

	public SimpleNetworkHandler(Observer listener) {
		super(listener);
	}
	...
	protected abstract void handleOutput(OutputStream connection) throws Exception;
